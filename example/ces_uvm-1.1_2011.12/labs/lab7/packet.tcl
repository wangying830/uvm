...
# DVE full session
# Saved on Wed Dec 21 15:04:36 2011
# Designs open: 1
#   V1: vcdplus.vpd
...
#<Session mode="Full" path="/remote/us01home17/jachang/ces_uvm-1.1_2011.12/labs/lab7/packet.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{65 145} {1273 1017}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 145} {height 438} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 211} {height 438} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Transaction.1} {{left 0} {top 0} {width 1208} {height 200} {dock_state bottom} {dock_on_new_line true} {child_transaction_col_expand 16} {child_transaction_col_time 90} {child_transaction_col_message 63} {child_transaction_col_caller 68} {child_transaction_col_name 43} {child_transaction_col_scope 147} {child_transaction_col_severity 56} {child_transaction_col_type 38} {child_transaction_col_relation 57} {child_transaction_col_target 45}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1208} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{123 211} {1266 956}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 331} {child_wave_right 807} {child_wave_colname 163} {child_wave_colvalue 164} {child_wave_col1 0} {child_wave_col2 1}}
...
set sigs sigs
gui_sg_create ${sigs}
gui_sg_addsignal -group ${sigs} { router_test_top.sigs.clk router_test_top.sigs.reset_n router_test_top.sigs.frame_n router_test_top.sigs.valid_n router_test_top.sigs.din router_test_top.sigs.dout router_test_top.sigs.busy_n router_test_top.sigs.valido_n router_test_top.sigs.frameo_n router_test_top.host.wr_n router_test_top.host.address router_test_top.host.data router_test_top.host.clk }
...
catch {gui_list_select -id ${Hier.1} {router_test_top.host}}
...
gui_list_show_data -id ${Data.1} {router_test_top.host}
...
gui_wv_zoom_timerange -id ${Wave.1} 12229 29986
