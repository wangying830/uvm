...
# DVE full session
# Saved on Wed Dec 21 11:48:56 2011
# Designs open: 1
#   V1: vcdplus.vpd
...
#<Session mode="Full" path="/remote/us01home17/jachang/ces_uvm-1.1_2011.12/labs/lab4/packet.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 142} {height 430} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 208} {height 430} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Transaction.1 [gui_create_window -type Transaction -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 206]
gui_set_window_pref_key -window ${Transaction.1} -key dock_width -value_type integer -value -1
gui_set_window_pref_key -window ${Transaction.1} -key dock_height -value_type integer -value 206
gui_set_window_pref_key -window ${Transaction.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Transaction.1} {{left 0} {top 0} {width 1205} {height 205} {dock_state bottom} {dock_on_new_line true} {child_transaction_col_expand 16} {child_transaction_col_time 90} {child_transaction_col_message 63} {child_transaction_col_caller 68} {child_transaction_col_name 43} {child_transaction_col_scope 147} {child_transaction_col_severity 56} {child_transaction_col_type 38} {child_transaction_col_relation 57} {child_transaction_col_target 45}}
